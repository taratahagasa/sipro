...
export default function EmptyState({ icon: Icon = Inbox, title, description, actionLabel,
  ...
  return (
    <div data-testid={testId || WORK.emptyState} className="flex flex-col items-center justify-center rounded-xl border border-dashed bg-card/50 px-6 py-12 text-center">
